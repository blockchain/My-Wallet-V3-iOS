...
open class ERC20AssetAccountRepository: AssetAccountRepositoryAPI {
    ...
    private let service: ERC20AssetAccountDetailsService
    
    public init(service: ERC20AssetAccountDetailsService) {
