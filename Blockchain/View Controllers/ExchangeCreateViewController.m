...
- (void)viewDidLoad
{
    ...
    [self.exchangeView setupWithConversionView:NO createViewDelegate:self fromToButtonDelegate:self.fromToButtonDelegateIntermediate continueButtonInputAccessoryDelegate:self textFieldDelegate:self];
