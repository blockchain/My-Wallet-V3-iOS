...
#define BC_STRING_REMINDER_BACKUP_MESSAGE_FIRST_BITCOIN NSLocalizedString(@"Congrats, you have bitcoin! Now let’s backup your wallet to ensure you can access your funds if you forget your password.", nil)
#define BC_STRING_REMINDER_BACKUP_MESSAGE_HAS_BITCOIN NSLocalizedString(@"For your security, we do not keep any passwords on file. Backup your wallet to ensure your funds are safe in case you lose your password.", nil)
