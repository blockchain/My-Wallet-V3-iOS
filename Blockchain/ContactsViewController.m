...
- (void)shareInvitationClicked
{
    ...
    NSString *shareLink = [[[BlockchainAPI sharedInstance] walletUrl] stringByAppendingFormat:@"/invite#id=%@&name=%@", [identifier stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]], [sharedInfo stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]]];
