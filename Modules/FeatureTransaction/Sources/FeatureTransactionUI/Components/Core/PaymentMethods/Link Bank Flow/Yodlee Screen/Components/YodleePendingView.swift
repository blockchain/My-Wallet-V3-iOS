...
final class YodleePendingView: UIView {
    ...
    private func setupUI() {
        ...
        stackView.spacing = Spacing.padding1
        stackView.setCustomSpacing(Spacing.padding3, after: compositeView)

        addSubview(stackView)
        compositeView.layout(size: .edge(80))
        stackView.layoutToSuperview(.centerY, offset: -Spacing.padding2)
        ...
        buttonStackView.spacing = Spacing.padding2
        ...
        buttonStackView.layout(edge: .top, to: .bottom, of: stackView, relation: .greaterThanOrEqual, offset: Spacing.padding3)
        buttonStackView.layoutToSuperview(.leading, offset: Spacing.padding3)
        buttonStackView.layoutToSuperview(.trailing, offset: -Spacing.padding3)
        buttonStackView.layoutToSuperview(.bottom, usesSafeAreaLayoutGuide: true, offset: -Spacing.padding3)
    }
