...
public final class AmountTranslationView: UIView, AmountViewable {
    ...
    public init(
        ...
        outerStackView.layoutToSuperview(.leading, offset: Spacing.padding3)
        outerStackView.layoutToSuperview(.trailing, offset: -Spacing.padding3)
        outerStackView.layoutToSuperview(.top)
        outerStackView.layoutToSuperview(
            .bottom,
            offset: prefillButtonsEnabled ? -prefillViewHeight : -Spacing.padding1
        )
