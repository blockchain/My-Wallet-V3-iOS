...
class MockDefaultSwapCurrencyPairsService: DefaultSwapCurrencyPairsServiceAPI {
    ...
    func getDefaultPairs(
        sourceInformation: FeatureTransactionDomain.SelectionInformation?,
        targetInformation: FeatureTransactionDomain.SelectionInformation?
    ) async -> (source: FeatureTransactionDomain.SelectionInformation, target: FeatureTransactionDomain.SelectionInformation)? {
