...
extension Localization.ActiveRewards {
...
extension Localization.PassiveRewards {
...
extension Localization.Staking {
...
extension Localization.Earn.Intro {
...
extension Localization.Earn.Compare {
    ...
    static func upToRateAnually(_ value: String) -> String { upToRateAnuallyFormat.interpolating(value) }

    private static let upToRateAnuallyFormat = NSLocalizedString(
        "Up to %@ annually",
        comment: "Earn: Compare Passive Rate title"
    )
}

extension Localization.Earn.Compare.Passive {
...
extension Localization.Earn.Compare.Staking {
...
extension Localization.Earn.Compare.Active {
